...
public class MainActivity extends Activity implements RCDeviceListener, RCConnectionListener, OnClickListener,
   ...
   public void onServiceConnected(ComponentName className, IBinder service)
   {
      ...
      params.put(RCDevice.ParameterKeys.SIGNALING_DOMAIN, "dektalk.homenet.org");
      params.put(RCDevice.ParameterKeys.SIGNALING_USERNAME, "dektalk");
      params.put(RCDevice.ParameterKeys.SIGNALING_PASSWORD, "dektalk");
      ...
      params.put(RCDevice.ParameterKeys.MEDIA_TURN_ENABLED, false);
   ...
   public void onClick(View view)
   {
      if (view.getId() == R.id.button_dial) {
         ...
         connectParams.put(RCConnection.ParameterKeys.CONNECTION_PEER, "sip:+1235@dektalk.homenet.org");
